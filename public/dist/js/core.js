          ...
          function (e, t) {
            C.fn[e] = function (n, i) {
              ...
              return (
                ...
                this.length > 1 &&
                  (P[e] || C.uniqueSort(o), I.test(e) && o.reverse()),
                this.pushStack(o)
              );
            };
          }
                    ...
                    I.push({
                      ...
                      author_data: {
                        ...
                        screen_name: E[P]
                          ...
                          : null,
                        name: E[P]
                          ? E[P].querySelector('[data-scribe="element:name"]')
                              .title
                          : null,
                      },
                      time: $[P].textContent,
                  ...
                  for (; P < N; ) {
                    if ("string" != typeof a) {
                      var L = $[P].getAttribute("datetime"),
                        ...
                        H = a(M, L);
                      if (
                        ($[P].setAttribute("aria-label", H), S[P].textContent)
                      )
                    ...
                    if (
                      (n
                        ? (h && (b(S[P]), s && b(E[P])),
                          s &&
                            (F +=
                              ...
                              "</div>"),
                          (F +=
                            '<p class="tweet">' + y(S[P].innerHTML) + "</p>"),
                          r &&
                            (F += m
                        ...
                        : (S[P].textContent,
                          s &&
                            (F +=
                              '<p class="user">' + E[P].textContent + "</p>"),
                          (F +=
                            '<p class="tweet">' + S[P].textContent + "</p>"),
                          r &&
                            (F +=
                              '<p class="timePosted">' +
                              $[P].textContent +
